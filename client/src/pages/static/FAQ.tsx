  ...
  const faqCategories = [
      ...
      questions: [
        {
          ...
          answer:
            "بذرة هي منصة متكاملة تجمع بين تقييم الأفكار بالذكاء الاصطناعي، والتمويل الجماعي، والوساطة بين المستثمرين وأصحاب المشاريع. نهدف إلى تمكين رواد الأعمال من تحويل أفكارهم إلى مشاريع ناجحة.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "نعم، التسجيل وتقييم الأفكار مجاني تماماً. نأخذ عمولة بسيطة فقط من التمويل الناجح للمشاريع.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "كيف يعمل نظام التمويل؟",
          answer:
            "نوفر نظام تمويل جماعي حيث يمكن للمستثمرين دعم مشروعك مقابل مكافآت أو حصص. يمكنك تحديد هدف التمويل والمدة الزمنية والباقات المختلفة.",
        },
        {
          question: "ما هي رسوم المنصة؟",
          answer:
            "نأخذ عمولة 5% من التمويل الناجح فقط. لا توجد رسوم مقدمة أو رسوم شهرية.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          answer:
            "يمكنك الحصول على رابط إحالة فريد ومشاركته. ستحصل على عمولة من كل عملية تمويل ناجحة تتم عبر رابطك. نسب العمولة تتراوح بين 2% إلى 5%.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "تُحتسب العمولة فور نجاح عملية التمويل، ويمكنك سحبها بعد 14 يوم عمل.",
        },
      ],
    },
    {
